...
#define LEFT_ARM_GRIPPER_MOVE_COMMAND 12
#define HEAD_ROTATE_COMMAND 13
#define FACE_TRACKING_COMMAND 14
#define FOLLOW_PERSON_COMMAND 15
#define POWER_DISABLE_COMMAND 16
#define CAPTURE_HEAD_CAMERA 17
#define CAPTURE_LEFT_ARM_CAMERA 18
#define ERROR_PROCESSING 19
#define LEFT_ARM_WAVE_COMMAND 20
// ---------------------------------------------------------------------------
#ifdef __cplusplus
extern "C" {
#endif
